...
# Make_Pagination
#====================================================================================
Pag_Left_Disabled_HTML  = '<li class="page-item disabled"><a class="page-link" tabindex="-1">&laquo;</a></li>'
Pag_Left_Enabled_HTML   = '<li class="page-item"><a class="page-link" href="./log?page={page}">&laquo;</a></li>'
Pag_Cent_Disabled_HTML  = '<li class="page-item disabled"><a class="page-link" tabindex="-1">{page}</a></li>'
Pag_Cent_Enabled_HTML   = '<li class="page-item"><a class="page-link" href="./log?page={page}">{page}</a></li>'
Pag_Right_Disabled_HTML = '<li class="page-item disabled"><a class="page-link" tabindex="-1">&raquo;</a></li>'
Pag_Right_Enabled_HTML  = '<li class="page-item"><a class="page-link" href="./log?page={page}">&raquo;</a></li>'
...
def Make_Pagination( Num_Events, Lines_PP_Field, Current_Page ):
    ...
    current_app.logger.debug( "Num_Events {} Lines_PP {} Pages {} Current_Page {}".format( Num_Events, Lines_PP, Pages, Current_Page ))

    Result = ''
    if Pages == 1:
    #     Result = "<<d 1d >>d"
        Result += Pag_Left_Disabled_HTML + Pag_Cent_Disabled_HTML.format( page='1') + Pag_Right_Disabled_HTML
    elif Pages < 6:
        if Current_Page == 1:
            Result += Pag_Left_Disabled_HTML + Pag_Cent_Disabled_HTML.format( page='1')
        else:
            Result += Pag_Left_Enabled_HTML.format( page=Current_Page-1 ) + Pag_Cent_Enabled_HTML.format( page='1')
