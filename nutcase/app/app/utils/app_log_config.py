...
def Add_RF_Handler(app):
    Logfile_Fullname = os.path.join(app.config['CONFIG_PATH'],
                                    app.config['LOGFILE_SUBPATH'],
                                    app.config['LOGFILE_NAME'])

    Logfile_Handler = RotatingFileHandler(Logfile_Fullname, maxBytes=app.config['LOGFILE_MAXBYTES'],
...
def Add_Logging_Levels():
    ...
    #                   subject=app.config['MAIL_DEFAULT_SUBJECT'] + " " + 'App Failure',
